...
module.exports = function(RED) {
	...
	function tinkerForgeIndDualRelay(n) {
        ...
        function(connectReason) {
            node.dr = new Tinkerforge.BrickletIndustrialDualRelay(node.sensor, node.ipcon);
        });
    ...
    RED.nodes.registerType('TinkerForge IndDualRelay', tinkerForgeIndDualRelay);
};

...
function BrickletAccelerometerV2(uid, ipcon) {
	...
	*/
	...
	this.setFilterConfiguration = function(iirBypass, lowPassFilter, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletAccelerometerV2.FUNCTION_SET_FILTER_CONFIGURATION, [iirBypass, lowPassFilter], 'B B', '', returnCallback, errorCallback, false);
	};
	this.getFilterConfiguration = function(returnCallback, errorCallback) {
		...
		.. versionadded:: 2.0.2$nbsp;(Plugin)
		*/
		this.ipcon.sendRequest(this, BrickletAccelerometerV2.FUNCTION_GET_FILTER_CONFIGURATION, [], '', 'B B', returnCallback, errorCallback, false);
	};

...
function BrickletDistanceUSV2(uid, ipcon) {
	...
	*/
	...
	this.callbackFormats[BrickletDistanceUSV2.CALLBACK_DISTANCE] = 'H';
	...
	this.getDistance = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_GET_DISTANCE, [], '', 'H', returnCallback, errorCallback, false);
	};
	this.setDistanceCallbackConfiguration = function(period, valueHasToChange, option, min, max, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_SET_DISTANCE_CALLBACK_CONFIGURATION, [period, valueHasToChange, option, min, max], 'I ? c H H', '', returnCallback, errorCallback, false);
	};
	this.getDistanceCallbackConfiguration = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_GET_DISTANCE_CALLBACK_CONFIGURATION, [], '', 'I ? c H H', returnCallback, errorCallback, false);
	};
	this.setUpdateRate = function(updateRate, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_SET_UPDATE_RATE, [updateRate], 'B', '', returnCallback, errorCallback, false);
	};
	this.getUpdateRate = function(returnCallback, errorCallback) {
		/*
		Returns the update rate as set by :func:`Set Update Rate`.
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_GET_UPDATE_RATE, [], '', 'B', returnCallback, errorCallback, false);
	};
	this.setDistanceLEDConfig = function(config, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_SET_DISTANCE_LED_CONFIG, [config], 'B', '', returnCallback, errorCallback, false);
	};
	this.getDistanceLEDConfig = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_GET_DISTANCE_LED_CONFIG, [], '', 'B', returnCallback, errorCallback, false);
	};
	this.getSPITFPErrorCount = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_GET_SPITFP_ERROR_COUNT, [], '', 'I I I I', returnCallback, errorCallback, false);
	};
	this.setBootloaderMode = function(mode, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_SET_BOOTLOADER_MODE, [mode], 'B', 'B', returnCallback, errorCallback, false);
	};
	this.getBootloaderMode = function(returnCallback, errorCallback) {
		/*
		Returns the current bootloader mode, see :func:`Set Bootloader Mode`.
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_GET_BOOTLOADER_MODE, [], '', 'B', returnCallback, errorCallback, false);
	};
	this.setWriteFirmwarePointer = function(pointer, returnCallback, errorCallback) {
		...
		necessary to call it in a normal user program.
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_SET_WRITE_FIRMWARE_POINTER, [pointer], 'I', '', returnCallback, errorCallback, false);
	};
	this.writeFirmware = function(data, returnCallback, errorCallback) {
		...
		necessary to call it in a normal user program.
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_WRITE_FIRMWARE, [data], 'B64', 'B', returnCallback, errorCallback, false);
	};
	this.setStatusLEDConfig = function(config, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_SET_STATUS_LED_CONFIG, [config], 'B', '', returnCallback, errorCallback, false);
	};
	this.getStatusLEDConfig = function(returnCallback, errorCallback) {
		/*
		Returns the configuration as set by :func:`Set Status LED Config`
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_GET_STATUS_LED_CONFIG, [], '', 'B', returnCallback, errorCallback, false);
	};
	this.getChipTemperature = function(returnCallback, errorCallback) {
		...
		temperature changes.
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_GET_CHIP_TEMPERATURE, [], '', 'h', returnCallback, errorCallback, false);
	};
	this.reset = function(returnCallback, errorCallback) {
		...
		undefined behavior!
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_RESET, [], '', '', returnCallback, errorCallback, false);
	};
	this.writeUID = function(uid, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_WRITE_UID, [uid], 'I', '', returnCallback, errorCallback, false);
	};
	this.readUID = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_READ_UID, [], '', 'I', returnCallback, errorCallback, false);
	};
	this.getIdentity = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletDistanceUSV2.FUNCTION_GET_IDENTITY, [], '', 's8 s8 c B3 B3 H', returnCallback, errorCallback, false);
	};
}

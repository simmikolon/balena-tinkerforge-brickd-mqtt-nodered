...
function BrickletXMC1400Breakout(uid, ipcon) {
	...
	*/
	...
	this.callbackFormats[BrickletXMC1400Breakout.CALLBACK_ADC_VALUES] = 'H8';
	this.callbackFormats[BrickletXMC1400Breakout.CALLBACK_COUNT] = 'I';
	...
	this.setGPIOConfig = function(port, pin, mode, inputHysteresis, outputLevel, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_SET_GPIO_CONFIG, [port, pin, mode, inputHysteresis, outputLevel], 'B B B B ?', '', returnCallback, errorCallback, false);
	};
	this.getGPIOInput = function(port, pin, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_GET_GPIO_INPUT, [port, pin], 'B B', '?', returnCallback, errorCallback, false);
	};
	this.setADCChannelConfig = function(channel, enable, returnCallback, errorCallback) {
		...
		* Channel 7: P2_2
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_SET_ADC_CHANNEL_CONFIG, [channel, enable], 'B ?', '', returnCallback, errorCallback, false);
	};
	this.getADCChannelConfig = function(channel, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_GET_ADC_CHANNEL_CONFIG, [channel], 'B', '?', returnCallback, errorCallback, false);
	};
	this.getADCChannelValue = function(channel, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_GET_ADC_CHANNEL_VALUE, [channel], 'B', 'H', returnCallback, errorCallback, false);
	};
	this.getADCValues = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_GET_ADC_VALUES, [], '', 'H8', returnCallback, errorCallback, false);
	};
	this.setADCValuesCallbackConfiguration = function(period, valueHasToChange, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_SET_ADC_VALUES_CALLBACK_CONFIGURATION, [period, valueHasToChange], 'I ?', '', returnCallback, errorCallback, false);
	};
	this.getADCValuesCallbackConfiguration = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_GET_ADC_VALUES_CALLBACK_CONFIGURATION, [], '', 'I ?', returnCallback, errorCallback, false);
	};
	this.getCount = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_GET_COUNT, [], '', 'I', returnCallback, errorCallback, false);
	};
	this.setCountCallbackConfiguration = function(period, valueHasToChange, option, min, max, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_SET_COUNT_CALLBACK_CONFIGURATION, [period, valueHasToChange, option, min, max], 'I ? c I I', '', returnCallback, errorCallback, false);
	};
	this.getCountCallbackConfiguration = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_GET_COUNT_CALLBACK_CONFIGURATION, [], '', 'I ? c I I', returnCallback, errorCallback, false);
	};
	this.getSPITFPErrorCount = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_GET_SPITFP_ERROR_COUNT, [], '', 'I I I I', returnCallback, errorCallback, false);
	};
	this.setBootloaderMode = function(mode, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_SET_BOOTLOADER_MODE, [mode], 'B', 'B', returnCallback, errorCallback, false);
	};
	this.getBootloaderMode = function(returnCallback, errorCallback) {
		/*
		Returns the current bootloader mode, see :func:`Set Bootloader Mode`.
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_GET_BOOTLOADER_MODE, [], '', 'B', returnCallback, errorCallback, false);
	};
	this.setWriteFirmwarePointer = function(pointer, returnCallback, errorCallback) {
		...
		necessary to call it in a normal user program.
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_SET_WRITE_FIRMWARE_POINTER, [pointer], 'I', '', returnCallback, errorCallback, false);
	};
	this.writeFirmware = function(data, returnCallback, errorCallback) {
		...
		necessary to call it in a normal user program.
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_WRITE_FIRMWARE, [data], 'B64', 'B', returnCallback, errorCallback, false);
	};
	this.setStatusLEDConfig = function(config, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_SET_STATUS_LED_CONFIG, [config], 'B', '', returnCallback, errorCallback, false);
	};
	this.getStatusLEDConfig = function(returnCallback, errorCallback) {
		/*
		Returns the configuration as set by :func:`Set Status LED Config`
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_GET_STATUS_LED_CONFIG, [], '', 'B', returnCallback, errorCallback, false);
	};
	this.getChipTemperature = function(returnCallback, errorCallback) {
		...
		temperature changes.
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_GET_CHIP_TEMPERATURE, [], '', 'h', returnCallback, errorCallback, false);
	};
	this.reset = function(returnCallback, errorCallback) {
		...
		undefined behavior!
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_RESET, [], '', '', returnCallback, errorCallback, false);
	};
	this.writeUID = function(uid, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_WRITE_UID, [uid], 'I', '', returnCallback, errorCallback, false);
	};
	this.readUID = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_READ_UID, [], '', 'I', returnCallback, errorCallback, false);
	};
	this.getIdentity = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletXMC1400Breakout.FUNCTION_GET_IDENTITY, [], '', 's8 s8 c B3 B3 H', returnCallback, errorCallback, false);
	};
}
